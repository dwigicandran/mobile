...
@Slf4j
@Service("getListMonth")
public class GetListMonth extends MbBaseServiceImpl implements MbService {

    @Value("${commons.getListMonth}")
    private String listMonthUrl;
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        log.info("Get GetInfoListSetting Month Running");
        ...
        try {
            ...
            String url = listMonthUrl + requestParam;

            log.info("ListMonth Url: " + listMonthUrl);
