...
@Slf4j
@Service("getListSupplierAqiqah")
public class GetListSuplierAqiqah extends MbBaseServiceImpl implements MbService {

    @Value("${list.suplier.aqiqah}")
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        log.info("Get GetInfoListSetting Suplier Aqiqah");
        ...
        try {
            ...
            log.info("GetInfoListSetting Suplier Aqiqah Url : " + url);
            ...
            log.info("GetInfoListSetting Suplier Aqiqah Response : " + new Gson().toJson(mbApiResp));
        } catch (Exception e) {
