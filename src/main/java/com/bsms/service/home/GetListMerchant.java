...
public class GetListMerchant extends MbBaseServiceImpl implements MbService {

    @Value("${list.merchant}")
    private String listMerchantUrl;
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        log.info("Get GetInfoListSetting Merchant Running");
