...
@Slf4j
@Service("getTausiah")
public class GetTausiah extends MbBaseServiceImpl implements MbService {

    @Value("${list.tausiah}")
    private String tausiahUrl;
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        log.info("Get GetInfoListSetting Tausiah");
