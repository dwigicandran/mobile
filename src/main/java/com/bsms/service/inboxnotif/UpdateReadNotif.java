...
@Slf4j
@Service("updateReadNotif")
public class UpdateReadNotif extends MbBaseServiceImpl implements MbService {

    @Value("${notif.updateReadNotif}")
    private String updateReadNotif;
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        try {
            ...
            String url = updateReadNotif;
            log.info("updateReadNotif Url : " + url);
            ...
            log.info("updateReadNotif Response : " + new Gson().toJson(mbApiResp));
        } catch (Exception e) {
