...
@Slf4j
@Service("deleteMultiNotif")
public class DeleteMultiNotif extends MbBaseServiceImpl implements MbService {

    @Value("${notif.deleteMultiNotif}")
    private String deleteMultiNotif;
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        try {
            ...
            String url = deleteMultiNotif;
            log.info("deleteMultiNotif Url : " + url);
            ...
            log.info("deleteMultiNotif Response : " + new Gson().toJson(mbApiResp));
        } catch (Exception e) {
