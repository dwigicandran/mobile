...
public class UpdateReceipt extends MbBaseServiceImpl implements MbService {

    @Value("${notif.updateReceipt}")
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        try {
            ...
            String url = updateReceipt;
            log.info("updateReceipt Url : " + url);
            ...
            log.info("updateReceipt Response : " + new Gson().toJson(mbApiResp));
        } catch (Exception e) {
