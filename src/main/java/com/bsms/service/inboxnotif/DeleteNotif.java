...
@Slf4j
@Service("deleteNotif")
public class DeleteNotif extends MbBaseServiceImpl implements MbService {

    @Value("${notif.deleteNotif}")
    private String deleteNotif;
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        try {
            ...
            String url = deleteNotif;
            log.info("deleteNotif Url : " + url);
            ...
            log.info("deleteNotif Response : " + new Gson().toJson(mbApiResp));
        } catch (Exception e) {
