...
import com.bsms.restobjclient.account.ListAccountDispResp;
import com.bsms.restobjclient.account.ListAccountReq;
import com.bsms.restobjclient.account.ListAccountResp;
import com.bsms.restobjclient.account.OnlineStatementResp;
import com.bsms.restobjclient.portfolio.PortofolioResp;
...
public class MbListAccountServiceImpl extends MbBaseServiceImpl implements MbService {
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request)
        ...
        System.out.println("list account request :");
        ...
        try {
            ...
            System.out.println("response list account :" + new Gson().toJson(listAccountResp));
            ...
            if ("00".equals(listAccountResp.getResponseCode())) {
                ...
                try {
                    ...
                    System.out.println("list account req url : " + portofolioUrl);
