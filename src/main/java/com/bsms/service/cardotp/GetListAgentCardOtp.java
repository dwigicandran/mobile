...
public class GetListAgentCardOtp extends MbBaseServiceImpl implements MbService {

    @Value("${cardotp.getListAgent}")
    private String getLayananUrl;
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        log.info("Get Layanan CardOtp Request : " + new Gson().toJson(request));
        ...
        try {
            ...
            String url = getLayananUrl;

            log.info("Get Layanan CardOtp URL : " + url);

            ResponseEntity<BaseResponse> restResponse = restTemps.exchange(url, HttpMethod.POST, req, BaseResponse.class);

            log.info("Get Layanan CardOtp Response : " + new Gson().toJson(restResponse));
