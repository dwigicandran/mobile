...
@Slf4j
@Service("doOdcConfirmAdd")
public class OdcConfirmAdd extends MbBaseServiceImpl implements MbService {

    @Value("${cardotp.odc.confirmAdd}")
    private String odcConfirmUrl;
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        log.info("Get CardOtp Odc Confirm Add Request : " + new Gson().toJson(request));
        ...
        try {
            ...
            String url = odcConfirmUrl;

            log.info("Get CardOtp Odc Confirm Add URL : " + url);

            ResponseEntity<BaseResponse> restResponse = restTemps.exchange(url, HttpMethod.POST, req, BaseResponse.class);

            log.info("Get CardOtp Odc Confirm Add Response : " + new Gson().toJson(restResponse));
