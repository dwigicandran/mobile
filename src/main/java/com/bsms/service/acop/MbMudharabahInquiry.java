...
@Service("doInquiryMudharabah")
public class MbMudharabahInquiry extends MbBaseServiceImpl implements MbService  {

	@Value("${mudharabah.doInquiry}")
    private String doInquiryMudharabah;
	...
	public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request)
			throws Exception {
	        	...
	        	System.out.println("::: doInquiryMudharabah Microservices Request :::");
	            ...
	            try {
	            	...
	            	String url = doInquiryMudharabah;
	    			...
	    			System.out.println("::: doInquiryMudharabah Microservices Response :::");
