...
@Service("doOpeningMudharabah")
public class MbMudharabahOpening extends MbBaseServiceImpl implements MbService  {

	@Value("${mudharabah.doOpening}")
    private String doOpeningMudharabah;
	...
	public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request)
			throws Exception {
	        	...
	        	System.out.println("::: doOpeningMudharabah Microservices Request :::");
	            ...
	            try {
	            	...
	            	String url = doOpeningMudharabah;
