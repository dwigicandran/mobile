...
@Service("doOpeningMabrur")
public class MbMabrurOpening extends MbBaseServiceImpl implements MbService  {

	@Value("${mabrur.doOpening}")
    private String doOpeningMabrur;
	...
	public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request)
			throws Exception {
	        	...
	        	System.out.println("::: doOpeningMabrur Microservices Request :::");
	            ...
	            try {
	    			...
	    			System.out.println("::: doOpeningMabrur Microservices Response :::");
