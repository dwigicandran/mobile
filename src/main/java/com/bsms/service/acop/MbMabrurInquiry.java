...
@Service("doInquiryMabrur")
public class MbMabrurInquiry extends MbBaseServiceImpl implements MbService  {

	@Value("${mabrur.doInquiry}")
    private String doInquiryMabrur;
	...
	public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request)
			throws Exception {
	        	...
	        	System.out.println("::: doInquiryMabrur Microservices Request :::");
	            ...
	            try {
	    			...
	    			System.out.println("::: doInquiryMabrur Microservices Response :::");
