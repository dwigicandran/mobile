package com.bsms.service.acop.autosave;
...
@Slf4j
@Service("autoSaveInquriy")
public class AutosaveInquiry extends MbBaseServiceImpl implements MbService {

    @Value("${autosave.inquiry}")
    private String autoSaveUrl;
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        log.info("Autosave Inquiry Running");
        ...
        try {
            ...
            String url = autoSaveUrl;

            log.info("Autosave Inquiry Url : " + url);
            ...
            log.info("Autosave Inquiry Response : " + new Gson().toJson(response));
