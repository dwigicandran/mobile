...
public class GetListAccountType extends MbBaseServiceImpl implements MbService {
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        log.info("Get List Account Type Running");
        ...
        try {
            ...
            log.info("Get List Account Type Url : " + url);
            ...
            log.info("Get List Account Type Response : " + new Gson().toJson(response));
