...
@Slf4j
@Service("autoSaveGetAccList")
public class GetListAccount extends MbBaseServiceImpl implements MbService {

    @Value("${autosave.getListAcc}")
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        log.info("Get List Account Running");
        ...
        try {
            ...
            log.info("Get List Account Url : " + url);
            ...
            log.info("Get List Account Response : " + new Gson().toJson(response));
