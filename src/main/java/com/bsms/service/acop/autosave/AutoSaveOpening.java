...
@Slf4j
@Service("autoSaveOpening")
public class AutoSaveOpening extends MbBaseServiceImpl implements MbService {

    @Value("${autosave.opening}")
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        log.info("Autosave Opening Running");
        ...
        try {
            ...
            log.info("Autosave Opening Url : " + url);
            ...
            log.info("Autosave Opening Response : " + new Gson().toJson(response));
