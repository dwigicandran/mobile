...
@Slf4j
@Service("autoSaveDoBreak")
public class DoBreak extends MbBaseServiceImpl implements MbService {

    @Value("${autosave.doBreak}")
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        log.info("Autosave Do Break Running");
        ...
        try {
            ...
            log.info("Autosave Do Break Url : " + url);
            ...
            log.info("Autosave Do Break Response : " + new Gson().toJson(response));
