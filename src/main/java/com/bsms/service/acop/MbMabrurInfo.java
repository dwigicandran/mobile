...
@Service("getAOInfoMabrur")
public class MbMabrurInfo extends MbBaseServiceImpl implements MbService  {

	@Value("${mabrur.getAOInfo}")
    private String getAOInfoMabrur;
