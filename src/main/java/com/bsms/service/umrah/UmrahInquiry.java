...
@Slf4j
@Service("umrahInquiry")
public class UmrahInquiry extends MbBaseServiceImpl implements MbService {
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        log.info("::: doInquiry Umrah Request RUN :::");
        ...
        try {
            ...
            log.info("Umrah INQUIRY URL : " + url);
            log.info("::: Umrah Inquiry Response :::");
