...
@Slf4j
@Service("doPaymentWakaf")
public class doPaymentWakaf extends MbBaseServiceImpl implements MbService {

    @Value("${ziswaf.doPaymentyWakaf}")
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        try {
            ...
            log.info("Wakaf Url : " + url);
            log.info("Wakaf Request : " + new Gson().toJson(req));
            ...
            log.info("::: doPayment Wakaf Response :::");
