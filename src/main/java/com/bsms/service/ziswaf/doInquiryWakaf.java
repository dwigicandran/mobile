...
@Slf4j
@Service("doInquiryWakaf")
public class doInquiryWakaf extends MbBaseServiceImpl implements MbService {

    @Value("${ziswaf.doInquiryWakaf}")
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        try {
            ...
            log.info("::: doInqury Wakaf Response :::");
