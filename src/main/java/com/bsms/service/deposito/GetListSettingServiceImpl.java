...
@Service("getListDepositoSetting")
public class GetListSettingServiceImpl extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(GetListSettingServiceImpl.class);

    @Value("${deposito.listsetting}") private String endpoint;
