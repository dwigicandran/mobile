...
@Service("doDepositoSetting")
public class DoDepositoSettingServiceImpl extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(DoDepositoSettingServiceImpl.class);

    @Value("${deposito.dodepositosetting}") private String endpoint;
