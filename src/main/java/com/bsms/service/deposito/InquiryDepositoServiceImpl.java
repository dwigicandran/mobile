...
@Service("inquiryDeposito")
public class InquiryDepositoServiceImpl extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(InquiryDepositoServiceImpl.class);

    @Value("${deposito.inquiry}") private String endpoint;
