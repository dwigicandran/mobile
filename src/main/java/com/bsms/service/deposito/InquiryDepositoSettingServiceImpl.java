package com.bsms.service.deposito;
...
@Service("inquiryDepositoSetting")
public class InquiryDepositoSettingServiceImpl extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(InquiryDepositoSettingServiceImpl.class);

    @Value("${deposito.inquirysetting}") private String endpoint;
