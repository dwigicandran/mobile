...
@Service("getListDepositoPeriod")
public class GetListDepositoPeriodServiceImpl extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(GetListDepositoPeriodServiceImpl.class);

    @Value("${deposito.listperiod}") private String endpoint;
