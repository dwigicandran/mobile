...
@Service("openingDeposito")
public class OpeningDepositoServiceImpl extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(OpeningDepositoServiceImpl.class);

    @Value("${deposito.opening}") private String endpoint;
