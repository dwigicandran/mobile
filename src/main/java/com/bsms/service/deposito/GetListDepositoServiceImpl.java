...
@Service("getListDeposito")
public class GetListDepositoServiceImpl extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(GetListDepositoServiceImpl.class);

    @Value("${deposito.list}") private String endpoint;
