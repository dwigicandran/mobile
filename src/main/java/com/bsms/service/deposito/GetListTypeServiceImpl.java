...
@Service("getListType")
public class GetListTypeServiceImpl extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(GetListTypeServiceImpl.class);

    @Value("${deposito.listtype}") private String endpoint;
