package com.bsms.service.blockcard;
...
@Slf4j
@Service("updateBlockCard")
public class BlockCardUpdate extends MbBaseServiceImpl implements MbService {

    @Autowired
    private MbTxLogRepository txLogRepository;

    @Value("${blockCard.update}")
    private String doUpdateUrl;
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        log.info("::: BlockCard Change Request RUN :::");
        ...
        try {
            ...
            log.info("BlockCard Change URL : " + url);
            log.info("::: BlockCard Change Response :::");
