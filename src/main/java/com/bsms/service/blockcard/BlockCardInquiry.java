...
@Slf4j
@Service("inqBlockCard")
public class BlockCardInquiry extends MbBaseServiceImpl implements MbService {

    @Autowired
    private MbTxLogRepository txLogRepository;

    @Value("${blockCard.inquiry}")
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        log.info("::: BlockCard Inquiry Request RUN :::");
        ...
        try {
            ...
            log.info("BlockCard INQUIRY URL : " + url);
            log.info("::: BlockCard Inquiry Response :::");
