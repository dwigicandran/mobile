...
@Service("printEgoldExecute")
public class EgoldPrintExeServiceImpl extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(EgoldPrintExeServiceImpl.class);

    @Value("${emas.print.execute}") private String endpoint;
