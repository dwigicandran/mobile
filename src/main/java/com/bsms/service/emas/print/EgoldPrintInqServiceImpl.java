...
@Service("printEgoldInq")
public class EgoldPrintInqServiceImpl extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(EgoldPrintInqServiceImpl.class);

    @Value("${emas.print.inquiry}") private String endpoint;
