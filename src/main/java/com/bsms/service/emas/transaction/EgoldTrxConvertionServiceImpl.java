...
@Service("emasTrxConvertion")
public class EgoldTrxConvertionServiceImpl extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(EgoldTrxConvertionServiceImpl.class);

    @Value("${emas.convertion.purchase}") private String endpointPurchase;
    @Value("${emas.convertion.sell}") private String endpointSell;
