...
@Service("emasProfileSetting")
public class EgoldProfileServiceImpl extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(EgoldProfileServiceImpl.class);

    @Value("${emas.profile.setting}") private String endpoint;
