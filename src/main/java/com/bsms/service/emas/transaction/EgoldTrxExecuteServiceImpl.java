...
@Service("emasTrxExecute")
public class EgoldTrxExecuteServiceImpl extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(EgoldTrxExecuteServiceImpl.class);

    @Value("${emas.execute.purchase}") private String endpointPurchase;
    @Value("${emas.execute.sell}") private String endpointSell;
    @Value("${emas.execute.trf}") private String endpointTrf;
