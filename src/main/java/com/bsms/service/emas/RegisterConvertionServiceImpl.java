...
@Service("emasRegisterConvertion")
public class RegisterConvertionServiceImpl extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(RegisterConvertionServiceImpl.class);

    @Value("${emas.register.convertion}") private String endpoint;
