...
@Service("emasRegisterInquiry")
public class RegisterInquiryServiceImpl extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(RegisterInquiryServiceImpl.class);

    @Value("${emas.register.inquiry}") private String endpoint;
