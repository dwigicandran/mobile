...
@Service("emasRegisterOpening")
public class RegisterOpeningServiceImpl extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(RegisterOpeningServiceImpl.class);

    @Value("${emas.register.opening}") private String endpoint;
