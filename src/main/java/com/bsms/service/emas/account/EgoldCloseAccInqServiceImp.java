package com.bsms.service.emas.account;
...
@Service("emasCloseAccInq")
public class EgoldCloseAccInqServiceImp extends MbBaseServiceImpl implements MbService {

    private static Logger log = LoggerFactory.getLogger(EgoldCloseAccInqServiceImp.class);

    @Value("${emas.closeacc.inq}") private String endpoint;
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        try{
            ...
            if (paymentInquiryResp.getResponseCode().equals("00")) {
                ...
                log.info(restResponse.getBody().getResponseMessage());
