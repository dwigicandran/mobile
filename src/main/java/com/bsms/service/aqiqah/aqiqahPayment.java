...
@Slf4j
@Service("aqiqahPayment")
public class aqiqahPayment extends MbBaseServiceImpl implements MbService {
    ...
    public MbApiResp process(HttpHeaders header, ContainerRequestContext requestContext, MbApiReq request) throws Exception {
        ...
        log.info("::: Payment aqiqah Request RUN :::");
        ...
        try {
            ...
            log.info("::: Aqiqah Payment URL :" + url);
            log.info("::: Aqiqah Payment Response :::");
